    ...
    public class DataAccessLayer : IDataAccessLayer<ProductReview> 
    {
        ...
        public DataAccessLayer()
        {
            this.reviews = new List<ProductReview> {
                ...
                new ProductReview { Id=4, Name="Miss Electa Kunde", Title="Fantastic", Avatar="https://s3.amazonaws.com/uifaces/faces/twitter/Stievius/128.jpg", Review=this.DEFAULT_REVIEW, CreatedAt=DateTime.Now },
