...
function initializePage() {
  ...
  document.querySelector('p.description').addEventListener('click', (ev) => {
    toggleDescriptionEdit(ev.target);
  });

  let inputDesc = document.getElementById('inputDesc');

  // Add the event listener for Enter, Escape
  ...
  // add event listener to toggle the form (Add Review / Hide Form button)
